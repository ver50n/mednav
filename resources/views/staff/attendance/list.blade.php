...
<div class="container-wrapper">
  <div class="subcontainer attendance">
    <div class="content-wrapper">
    <h4>@lang('common.attendance')@lang('common.list')</h4>
    ...
    <div class="grid-action-wrapper">
      ...
      <div class="grid-action">
        <form action="{{route('helpers.export').'?'.http_build_query(Request::query())}}" method="POST">
          @csrf
          <input type="hidden" name="model" value="Attendance" />
        ...
        <tr>
          <td>
            ...
            <form class="form-grid-delete"
              id="form-grid-delete"
              action="{{ route('manage.attendance.delete', ['id' => $row->id]) }}"
              method="POST"
              style="display: none;">
            @csrf
            </form>
...
@section('title')
  @include('layouts.includes.title', ['title' => \Lang::get('common.attendance') . \Lang::get('common.list')])
@endsection
