...
<div class="container-wrapper">
  <div class="subcontainer place">
    ...
    <h4>@lang('common.place')@lang('common.list')</h4>
        ...
        <tr>
          <td>
            ...
            <form class="form-grid-delete"
              id="form-grid-delete"
              action="{{ route('manage.place.delete', ['id' => $row->id]) }}"
              method="POST"
              style="display: none;">
            @csrf
            </form>
...
@section('title')
  @include('layouts.includes.title', ['title' => \Lang::get('common.place') . \Lang::get('common.list')])
@endsection
