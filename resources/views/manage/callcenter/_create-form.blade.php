    ...
    <div class="row">
      <div class="col-6">
        <section class="card components__card-section-wrapper">
          ...
          <div id="collapse-view__actual-working-info" class="collapse">
            <div class="card-body">
              <div class="form-group">
      ...
      <div class="col-6">
        <section class="card components__card-section-wrapper">
          ...
          <div id="collapse-view__fee-info" class="collapse">
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <textarea class="form-control form-control-sm"
                  name="note"
                  id="note"
                  placeholder="@lang('common.note')">{{ old('note') ? old('note') : "" }}</textarea>
                  ...
                  <tr>
                    ...
                    <td><label>
                      <input class="form-control form-control-sm price-field"
                        name="morning_wage"
                        id="morning_wage"
                        value="{{ old('morning_wage') ? old('morning_wage') : '0' }}"
                        readOnly
                  ...
                  <tr>
                    ...
                    <td><label>
                      <input class="form-control form-control-sm price-field"
                        name="noon_wage"
                        id="noon_wage"
                        value="{{ old('morning_wage') ? old('noon_wage') : '0' }}"
                        readOnly
                  ...
                  <tr>
                    ...
                    <td><label>
                      <input class="form-control form-control-sm price-field"
                        ...
                        value="{{ old('night_overtime_wage') ? old('night_overtime_wage') : '0' }}"
                        readOnly
                  ...
                  <tr>
                    ...
                    <td><label>
                      <input class="form-control form-control-sm price-field"
                        ...
                        value="{{ old('actual_working_hour_payment') ? old('actual_working_hour_payment') : 0 }}"
                        readOnly
                  ...
                  <tr>
                    ...
                    <td><label>
                      <input class="form-control form-control-sm price-field"
                        ...
                        value="{{ old('actual_overtime_hour_payment') ? old('actual_overtime_hour_payment') : 0 }}"
                        readOnly
                  ...
                  <tr>
                    ...
                    <td><label>
                      <input class="form-control form-control-sm price-field"
                        ...
                        id="invoice_payment"
                        value="{{ old('invoice_payment') ? old('invoice_payment') : '0' }}"
                        readOnly
